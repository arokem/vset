...
if ieNotDefined('cornerPoints')
    [fullRGB, mLocs, pSize, cornerPoints] = ieMacbethSelect(sensor,showSelection,fullData);
else
    [fullRGB, mLocs, pSize, cornerPoints] = ieMacbethSelect(sensor,showSelection,fullData,cornerPoints);
end
