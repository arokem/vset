function [scene,fname] = sceneFromFile(filename,imageType,meanLuminance,dispCal,wList)
% Create a scene structure by reading data from a file
%
%     [scene,fname] = sceneFromFile(filename,[imageType],[meanLuminance],[dispCal],[wList])
%
...
switch lower(imageType)
    case {'monochrome','rgb'}  % 'unispectral'
        ...
        scene = sceneSet(scene,'illuminant energy', sum(d.spd,2));
    ...
    case {'multispectral','hyperspectral'}
        ...
        % The scene radiance is in photons
        % The illuminant is in energy.
        % Sorry about that.
        ...
        % The illuminant sructure is set here
