...
%% Read in the scene
wList = [420:10:950];
fullFileName = fullfile('I:\ISET SceneDataFiles\Faces\Francisco.mat');
...
daylight = vcReadSpectra('D65.mat',wave);
...
scene = sceneSet(scene,'illuminantComment','Daylight (D65) illuminant');
