...
%
%  This script illustrates how to load color filters and set the
%  various pixel and optics parameters for your camera.
%
%
% (c) Stanford University, Psych 221, Wandell
...
vcAddAndSelectObject('sensor',sensorM); sensorImageWindow;
