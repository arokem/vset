...
lgt = vcReadSpectra('d65',wavelength);
...
XYZ = vcReadSpectra('XYZ',wavelength);
% Added 01-06-2005 PC
grayXYZ = XYZ'*graySPD
...
grayLAB = xyz2lab( grayXYZ.', whiteXYZ.' ).'
...
% 
lab1 = xyz2lab( grayXYZ.', whiteXYZ.' ).';
lab2 = xyz2lab( ( grayXYZ + deltaXYZ ).', whiteXYZ.' ).';
diffLAB = lab1 - lab2;
...
% pixels.
%
% - You can use xyz2lab to convert XYZ data to LAB data in bulk.
% xyz2lab may take an nx3 matrix of XYZ values to LAB values 
