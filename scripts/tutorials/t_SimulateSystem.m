%% t_SimulateSystem.m
%
% This script introduces how to create the full array of elements that make up the image simulation steps.
%   
% Scene: The script begins by creating a full spectral scene. 
%
% Optics: The radiance data are passed through the optics to create an
% irradiance image at the sensor surface.
%
% Sensor: The irradiance is then captured by a simulated sensor, resulting
% in an array of output voltages.
%
% Processor: The sensor array is demosaiced, color-balanced, and rendered
% on a display
%
% Use t_"TAB KEY" to see the list of tutorials
% Use s_"TAB KEY" to see the list of ISET scripts.
%
% See also: t_Introduction.m and t_IntroductionOI.m
%
% To learn more about a particular function, type "help function" as in "help sensorCreate".  
% There are also online descriptions of the functions
...
%
% One is to use the sceneCreate function.  Two examples are listed here.
% For a complete list type "help sceneCreate"
%
...
%
% See t-IntroductionScene.m for more information about scenes

patchSize = 64;
spectrum.wave = wave;
scene = sceneCreate('macbethtungsten',patchSize,spectrum);
