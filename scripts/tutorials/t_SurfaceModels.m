...
lgt = vcReadSpectra('d65',wave);  

% Or try these lights instead
% lgt  = vcReadSpectra('tungsten',wave);
% lgt  = vcReadSpectra('FluorescentOffice',wave); 
% lgt  = vcReadSpectra('Fluorescent2',wave); 
% lgt  = vcReadSpectra('Fluorescent7',wave); 
% lgt  = vcReadSpectra('Fluorescent11',wave);
