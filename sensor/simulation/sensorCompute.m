function sensor = sensorCompute(sensor,oi,showWaitBar)
%Compute sensor response using sensor parameters and optical image data
%
%   sensor = sensorCompute([sensor],[oi],[showWaitBar = 1])
%
...
if ~exist('showWaitBar','var') || isempty(showWaitBar),    showWaitBar = 1; end
...
if showWaitBar, unitSigCurrent = signalCurrent(oi,sensor,wBar);
