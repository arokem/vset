...
%
% The RGB image represents the general appearance of the spectral power
% distribution (spd) data.
%
...
% Actually display the rendered RGB.  Sometimes we just return the RGB
% values. 
if displayFlag >= 1
