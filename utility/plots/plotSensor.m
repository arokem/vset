...
%
% These plots characterizing the data, parts, or performance of
% the sensor.  
%
...
if nSensors > 1
    ...
    data = plane2mosaic(data,sensor,NaN);
    ...
    uData = plotSensorLineColor(xy,pos,data,ori,nSensors,dataType,sORt,fColors, figNum);
elseif nSensors == 1
    figNum = vcNewGraphWin;
    uData = plotSensorLineMonochrome(xy,pos,data,ori,dataType,sORt,figNum);
end
end

%% Color sensor line
function uData = plotSensorLineColor(xy,pos,data,ori,nSensors,dataType,sORt,fColors,figNum)
%
...
function uData = plotSensorLineMonochrome(xy,pos,data,ori,dataType,sORt,figNum)
%
% Deal with monochrome sensor case.
%
