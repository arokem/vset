...
if cbType > 0
    ...
    %
    % LMS for 475, I guess. Closest to 473. vcReadSpectra('stockman',[473])
    anchor(1) = 0.08008;  anchor(2) = 0.1579;   anchor(3) = 0.5897;
    % LMS for 485, I guess. Closest to 482. % vcReadSpectra('stockman',[482])
    anchor(4) = 0.1284; anchor(5) = 0.2237; anchor(6) = 0.3636;
    % LMS for 575.  Pretty good.   % vcReadSpectra('stockman',[576])
    anchor(7) = 0.9856; anchor(8) = 0.7325; anchor(9) = 0.001079;
    % LMS for 660, Good.% vcReadSpectra('stockman',[662])
    anchor(10) = 0.0914;   anchor(11) = 0.007009;  anchor(12) = 0.0;
    % To verify the the calculations and values, do this:
    %  lms = vcReadSpectra('stockman',400:700);
