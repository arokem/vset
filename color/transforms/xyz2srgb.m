...
% values. The user can also get linear RGB values as well as the Y
% value (maxY) that is used to scale the XYZ image so that it is within the
% [0,1] range as required by the sRGB standard.
%
