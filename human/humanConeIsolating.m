...
%
%   [monitor,wave] = vcReadSpectra('newsomeLabMonitor');
...
if ieNotDefined('wave'),        [monitor,wave] = vcReadSpectra(monitorFile); 
else                            monitor = vcReadSpectra(monitorFile,wave); 
end

if ieNotDefined('cones'), cones = vcReadSpectra('stockmanAbs',wave); end
